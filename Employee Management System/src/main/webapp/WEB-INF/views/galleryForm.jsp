...
<!-- Custom CSS -->
<link
	href="${pageContext.request.contextPath}/resources/home/assets/libs/magnific-popup/dist/magnific-popup.css"
	rel="stylesheet">
<link
...
<body>
							...
							<div class="card">
								<div class="el-card-item">
									<div class="el-card-avatar el-overlay-1">
										<img alt="${imgname}" src="resources/imgs/${imgname}" />
										<div class="el-overlay">
											<ul class="list-style-none el-info">
												<li class="el-item"><a
													class="btn default btn-outline image-popup-vertical-fit el-link"
													href="resources/imgs/${imgname}" target="_blank"><i
														class="mdi mdi-magnify-plus"></i></a></li>
												<li class="el-item"><a
													class="btn default btn-outline el-link"
													href="resources/imgs/${imgname}" target="_blank"><i class="mdi mdi-link"></i></a></li>
											</ul>
										</div>
									</div>
	...
	<!-- this page js -->
	<script
		src="${pageContext.request.contextPath}/resources/home/assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/home/assets/libs/magnific-popup/meg.init.js"></script>
</body>
